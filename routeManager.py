...
import queue
from dataManager import get_orders
...
while not q.empty():
    class Drone:
        def __init__(self, id_code, availability=Status.AVAILABLE.name, localization=HOME, order=None):
